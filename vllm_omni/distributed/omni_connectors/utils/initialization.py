...
def create_connectors_from_config(
    ...
    for edge_key, connector_spec in connectors_config.items():
        ...
        try:
            # For Transfer Engine connector, adjust port and role based on purpose and caller
...
def initialize_orchestrator_connectors(
    ...
    For MooncakeTransferEngineConnector, separate ports are used for request_forwarding
